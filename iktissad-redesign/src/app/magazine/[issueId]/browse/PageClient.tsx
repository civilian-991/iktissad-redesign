...
export default function MagazineBrowsePageClient({ params }: { params: Promise<{ issueId: string }> }) {
  ...
  const info = magazineInfo[issueId] || { title: t('pages.magazine.title'), subtitle: '', pages: 20 };
          ...
          >
            <div className="flex items-center justify-between px-6 py-4">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <Home size={20} />
                  <span className="hidden md:inline font-[family-name:var(--font-display)]">{t('pages.magazine.allIssues')}</span>
                </Link>
              </div>
          ...
          >
            <div className="sticky top-0 bg-black/80 backdrop-blur-sm p-4 flex items-center justify-between z-10">
              <h2 className="text-white font-[family-name:var(--font-display)] font-bold text-xl">
                {t('pages.magazine.tableOfContents')}
              </h2>
              <button
