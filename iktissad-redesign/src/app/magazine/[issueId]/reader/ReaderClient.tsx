...
export default function ReaderClient({ issue, spreads, sections }: ReaderClientProps) {
  ...
  return (
    <>
      ...
      <a
        href="#article-text"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:start-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-gold focus:text-ink focus:rounded-lg focus:font-bold"
      >
