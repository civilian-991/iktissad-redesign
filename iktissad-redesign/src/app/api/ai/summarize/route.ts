  ...
  try {
    ...
    const [summary, summaryEn] = await Promise.all([
      callClaude(
        ...
        "أنت محرر متخصص في موقع إقتصاد المالي. اكتب ملخصاً موجزاً ودقيقاً بالعربية الفصحى. استخدم الأرقام الغربية (0-9) دائماً، لا الأرقام الهندية (الأرقام العربية الشرقية). أخرج النص فقط بدون أي تعليقات أو مقدمة."
      ),
      callClaude(
        apiKey,
