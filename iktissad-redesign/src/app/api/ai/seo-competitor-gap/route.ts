...
export async function POST(request: NextRequest) {
  ...
  const systemPrompt = `أنت محرر صحفي مالي خبير في المحتوى العربي ومحركات البحث. مهمتك تحليل مسودات المقالات وتحديد الثغرات مقارنةً بالمقالات المتصدرة لنتائج البحث.`
