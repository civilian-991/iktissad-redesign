  ...
  return (
    <div className="bg-midnight/50 backdrop-blur-sm border border-gold/10 rounded-xl p-5">
      ...
      <button
        onClick={handleCheck}
        disabled={isChecking}
        className="w-full flex items-center justify-center gap-2 py-2.5 bg-teal/10 border border-teal/20 rounded-xl text-teal text-sm font-[family-name:var(--font-display)] hover:bg-teal/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed mb-4"
      >
        {isChecking ? (
          <>
