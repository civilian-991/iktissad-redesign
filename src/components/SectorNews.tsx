              ...
              {sector.articles.filter(a => a.featured).map(article => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <h4 className="font-[family-name:var(--font-display)] font-bold text-white text-sm leading-snug line-clamp-2 drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)]">
                      {article.title}
                    </h4>
                    <span className="text-xs text-white mt-2 flex items-center gap-1 drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
                      <Clock size={12} />
                      {article.date}
                    </span>
                  </div>
